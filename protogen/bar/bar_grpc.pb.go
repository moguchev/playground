...
type BarClient interface {
	GetFooBar(ctx context.Context, in *GetFooRequest, opts ...grpc.CallOption) (*GetFooResponse, error)
}
...
func (c *barClient) GetFooBar(ctx context.Context, in *GetFooRequest, opts ...grpc.CallOption) (*GetFooResponse, error) {
	out := new(GetFooResponse)
	err := c.cc.Invoke(ctx, "/bar.Bar/GetFooBar", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BarServer interface {
	GetFooBar(context.Context, *GetFooRequest) (*GetFooResponse, error)
...
func (UnimplementedBarServer) GetFooBar(context.Context, *GetFooRequest) (*GetFooResponse, error) {
...
func _Bar_GetFooBar_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetFooRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BarServer).GetFooBar(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/bar.Bar/GetFooBar",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BarServer).GetFooBar(ctx, req.(*GetFooRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Bar_GetFooBar_Handler,
		},
	},
